...
import 'package:doctor_catalog/Services/patient_services.dart';
import 'package:doctor_catalog/screens/patient.dart';
import 'package:doctor_catalog/screens/update_patient.dart';
        ...
        Navigator.of(context)
          ...
          builder: (BuildContext context) {
            return new UpdatePatient(
                id: id, nom: nom, prenom: prenom, cin: cin, ntel: tel);
          },
        ));
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                onPressed: () {
                  PatientServices().DeletePatient(id).then((value) =>
                      Navigator.of(context)
