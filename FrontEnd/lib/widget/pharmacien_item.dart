...
import 'package:doctor_catalog/screens/update_pharmacien.dart';
...
class PharmacienItem extends StatelessWidget {
  ...
  const PharmacienItem(
      this.id, this.nom, this.prenom, this.cin, this.email, this.tel);
  @override
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                onPressed: () {
                  PharmacienServices().DeletePharmacien(id).then((value) =>
                      Navigator.of(context)
