...
import 'package:doctor_catalog/Services/ordonnance_services.dart';
import 'package:doctor_catalog/screens/ordonnance.dart';
import 'package:doctor_catalog/screens/update_ordonnance.dart';
      ...
      onTap: () {
        Navigator.of(context)
          ...
          builder: (BuildContext context) {
            return new UpdateOrdonnance(
                id: id, date: date, id_patient: id_patient);
          },
        ));
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                onPressed: () {
                  OrdonnanceServices().DeleteOrdonnance(id).then((value) =>
                      Navigator.of(context)
