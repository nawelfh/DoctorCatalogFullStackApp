...
class AddPharmacien extends StatefulWidget {
  const AddPharmacien({Key? key}) : super(key: key);

  @override
  _AddPharmacienState createState() => _AddPharmacienState();
}

class _AddPharmacienState extends State<AddPharmacien> {
  var nom;
  String? error = "";
  var prenom;
  var ntel;
            ...
            children: [
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    PharmacienServices()
                        .AddPharmacien(nom, prenom, cin, email, ntel)
                        .then((value) => {
                              if (value != "")
                                setState(() {
                                  print(value);
