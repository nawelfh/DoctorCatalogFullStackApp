...
class MedicamentServices{
  ...
  Future<String?> AddMedicament(String nom , String prix ,String id_pharmacien ,String id_ordonnance ) async {
    String url = "https://localhost:5001/medicament";
    if (nom !=null || prix!=null ||id_pharmacien !=null || id_ordonnance!=null  ) {
      final response =
